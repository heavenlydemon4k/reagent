...
class ProfileModel(Base):
    ...
    agent_name: Mapped[str] = mapped_column(String(100), default="Reagent")
    agent_tone: Mapped[str] = mapped_column(String(50), default="professional")
...
class MessageModel(Base):
    ...
    message_type: Mapped[str] = mapped_column(String(20), default="text")  # text, card, action, source
...
class CardModel(Base):
    ...
    card_type: Mapped[str] = mapped_column(String(20), nullable=False)  # decision, confirm, form, display
    payload_json: Mapped[dict] = mapped_column(JSON, default=dict)
    status: Mapped[str] = mapped_column(String(20), default="pending")  # pending, active, resolved
...
class DecisionModel(Base):
    ...
    user_id: Mapped[str] = mapped_column(String(36), nullable=False)
    action_type: Mapped[str] = mapped_column(String(20), nullable=False)  # reply, forward, archive, snooze, delegate
