...
logger = logging.getLogger("tts.circuit_breaker")
...
# Shared circuit breaker for ElevenLabs
elevenlabs_breaker = CircuitBreaker("elevenlabs", failure_threshold=5, reset_timeout=30.0)
