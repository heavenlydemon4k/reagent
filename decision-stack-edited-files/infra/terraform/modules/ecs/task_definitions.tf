...
# ==============================================================================
# FIXME: ARCHITECTURAL CONFLICT — This file defines a SEPARATE ECS module
# architecture (api, intelligence, voice) that CONFLICTS with main.tf
# (ingestion, classification, intelligence, sync) + the individual service
# files (ocr, stt, tts, calendar). Resources like aws_ecs_cluster.main are
# DUPLICATED between this file and main.tf, which will cause Terraform errors.
#
# MISSING SERVICES in this architecture (7 of 8 Decision Stack services):
# - ingestion      (defined in main.tf only)
# - classification (defined in main.tf only)
# - sync           (defined in main.tf only)
# - ocr            (defined in ocr_service.tf only)
# - stt            (defined in stt_service.tf only)
# - tts            (defined in tts_service.tf only)
# - calendar       (defined in calendar_service.tf only)
#
# TODO: Consolidate into a single ECS module architecture covering all
# 8 services: ingestion, classification, intelligence, sync, ocr, stt, tts, calendar.
# ==============================================================================
